...
(
	...
	Usr_Modificacion VARCHAR(50)  CONSTRAINT DF_SERVIDOR_USR_MODIFICACION DEFAULT SUSER_SNAME(),
	Fec_Modificacion DATETIME	  CONSTRAINT DF_SERVIDOR_FEC_MODIFICACION DEFAULT GETDATE(),
...
(
	...
	Usr_Modificacion VARCHAR(50)   CONSTRAINT DF_USUARIO_USR_MODIFICACION DEFAULT SUSER_SNAME(),
	Fec_Modificacion DATETIME	   CONSTRAINT DF_USUARIO_FEC_MODIFICACION DEFAULT GETDATE(),
...
(
	...
	Fec_Creacion	 DATETIME	   CONSTRAINT DF_CREDENCIAL_FEC_CREACION DEFAULT GETDATE(),
	Usr_Modificacion VARCHAR(50)   CONSTRAINT DF_CREDENCIAL_USR_MODIFICACION DEFAULT SUSER_SNAME(),
	Fec_Modificacion DATETIME	   CONSTRAINT DF_CREDENCIAL_FEC_MODIFICACION DEFAULT GETDATE(),
...
(
	...
	Usr_Modificacion	  VARCHAR(50)	CONSTRAINT DF_CREDENCIAL_HISTORIAL_USR_MODIFICACION DEFAULT SUSER_SNAME(),
	Fec_Modificacion	  DATETIME		CONSTRAINT DF_CREDENCIAL_HISTORIAL_FEC_MODIFICACION DEFAULT GETDATE(),
